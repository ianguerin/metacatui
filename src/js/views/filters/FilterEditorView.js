    ...
    */
    ...
    /** @lends FilterEditorView.prototype */{
        ...
        text: {
          ...
          step1: "var people filter your data by",
        ...
        */
        ...
        uiBuilderOptions: [
          ...
          },
          {
            ...
            description: "var people search for a range of years",
          ...
          },
          {
            ...
            description: "var people add or remove a single, specific search term",
            filterTypes: ["filter"],
            blockedFields: [...MetacatUI.appModel.get("querySemanticFields")],
            modelFunction: function (attrs) {
