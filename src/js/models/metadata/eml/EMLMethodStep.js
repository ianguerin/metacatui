...
//TODO(ianguerin): order is suddenly very important, this is not defined yet and should be optionally required within this definition.
...
define(['jquery',
  ...
  function ($, _, Backbone, DataONEObject, EMLText) {
    ...
    // TODO(ianguerin): figure this out
    const EMLSpecializedText = {};
        ...
        */
        ...
        initialize: function (attributes) {
          ...
          if (attributes.objectDOM) {
            ...
            try {
              var customMethodConfig = MetacatUI.appModel.get("customEMLMethods").find(config => config.id == attributes.customMethodID);
        ...
        parse: function (objectDOM) {
          ...
          try {
            ...
            if (customMethodOptions && customMethodOptions.length) {
              var specializedTextAttr = EMLSpecializedText.prototype.parse(description[0]),
        ...
        updateDOM: function () {
          ...
          try {
            ...
            if (description) {
              var updatedDescription = description.updateDOM();
              ...
              var existingDesc = $objectDOM.children("description");
